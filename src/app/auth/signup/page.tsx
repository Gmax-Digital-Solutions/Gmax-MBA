...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#08080c] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-white mb-2 mt-4">Create your account</h1>
