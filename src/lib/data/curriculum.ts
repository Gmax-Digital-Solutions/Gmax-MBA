...
export type Book = { id: string; title: string; author: string; why: string }
    ...
    modules: [
      ...
      },
      {
        ...
        books: [
          ...
          { id: 'b-11-3', title: 'The Art of the Deal', author: 'Multiple Authors', why: 'M&A dealmaking psychology from multiple practitioner perspectives.' },
        ],
        youtube: [
